...
if(TI_WITH_LLVM)
    ...
    if (TI_WITH_CUDA)
        ...
        add_subdirectory(taichi/runtime/program_impls/cuda_c)

        target_link_libraries(${CORE_LIBRARY_NAME} PRIVATE cuda_c_program_impl)
...
if(TI_WITH_PYTHON)
    ...
    if (TI_WITH_CUDA)
        target_link_libraries(${CORE_WITH_PYBIND_LIBRARY_NAME} PRIVATE cuda_c_program_impl)
        target_link_libraries(${CORE_WITH_PYBIND_LIBRARY_NAME} PRIVATE cuda_codegen)
        target_link_libraries(${CORE_WITH_PYBIND_LIBRARY_NAME} PRIVATE cuda_runtime)
    endif()
